...
export class SmartBot extends Bot {
  ...
  constructor(
    ...
    /*  if (this.botData.uuid === 'f2a693b0-dd4e-4318-b321-a840e6e98c9e') {
        this.relayGroupChatToDisc(
          'https://discord.com/api/webhooks/1109514902525181972/nc35dIpRCZrm38s2kYio3rASu1lFuoflZgUU1a9CX44VRdNvNhDgvwqj_OEkzjtfmqFo',
          '0e898714-daae-8362-e344-942cfb574925'
        );
        this.relayDiscordChatToSL(
          '1106247185525391431',
          '0e898714-daae-8362-e344-942cfb574925'
        );
      } */
